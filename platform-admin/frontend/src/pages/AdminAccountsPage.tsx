    ...
    <article className="platform-admin-card platform-admin-stack-card">
      ...
      <form className="platform-admin-form" onSubmit={onSubmit}>
        ...
        <button className="platform-admin-submit" type="submit">
          {showRoleSelector ? copy.accountControl.createButton : copy.accountControl.createTenantUser}
        </button>
      </form>
      ...
      <div className="platform-admin-list">
        {accounts.map((account) => (
          <div key={account.id} className="platform-admin-list-item is-static">
            ...
            <button className="platform-admin-secondary-button" type="button" onClick={() => onDeactivate(account.id)}>
